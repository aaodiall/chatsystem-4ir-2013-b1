...
public interface NiToCont {
     ...
     *
     * @param idRemoteSystem id of the remote system which sent the goodbye
     * message
     */
     ...
     * @param idRemoteSystem id of the remote system the text message has been
     * sent to
     */
     ...
     *
     * @param idRemoteSystem id of the remote system which confirmed the file's
     * transfert
    ...
    /**
     * Display a notification to inform the user that a problem occurs during
     * the connection
     */
    public void performConnectionError();

    /**
     * Display a notification to inform the user that a problem occurs during a
     * file Transfert
     *
